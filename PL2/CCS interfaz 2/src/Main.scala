  ...
  def actualizarMatriz(matriz : List[Int],vidas:Int, filas:Int,columnas:Int,filaObjetivo:Int,columnaObjetivo:Int,modo: Int, dificultad: Int, lim_inf: Int, lim_sup: Int): List[Int] = {
    ...
    if (elemento < 7) {
      ...
      if (contador == 1) {
        ...
        imprimirMatriz(nuevaMatriz_menosvida, filas, columnas)
        ...
        imprimirMatriz(nuevaMatrizB, filas, columnas)
        nuevaMatrizB
      }
      else if (contador == 6) {
        ...
        imprimirMatriz(nuevaMatrizTNT, filas, columnas)
        nuevaMatrizTNT
      }
      else if (contador >= 7) {
        ...
        imprimirMatriz(nuevaMatrizRx, filas, columnas)
        nuevaMatrizRx
      }
      else {
        //de 2 a 4
        ...
        imprimirMatriz(nuevaMatriz, filas, columnas)
        nuevaMatriz
      }
      ...
      imprimirMatriz(matrizBombaExplotada_rellenada, filas, columnas)
      ...
      imprimirMatriz(matrizTNTExplotada_rellenada, filas, columnas)
      ...
      imprimirMatriz(matrizRompecabezasExplotada_rellenada, filas, columnas)
